...
| Performed credential harvesting and network poisoning using Responder, Gained remote access in labs using reverse shell techniques, Executed buffer overflow exploit testing in controlled environments, Performed local privilege escalation (UAC bypass / Sticky Keys) in lab scenarios, Implemented persistence techniques and remote monitoring for red-team labs, Performed Active Directory reconnaissance to identify domain controllers and targets, Executed AS-REP Roasting attacks in controlled AD environments, Conducted password spraying and credential distribution using CrackMapExec, Performed post-enumeration and AD discovery using PowerView, Performed MSSQL service attack simulations to validate controls, Performed Kerberoasting attacks against service accounts in test environments.     | <a href="https://github.com/asyrafzf95/System-Hacking">System Hacking</a>|
| Simulated RAT-based access using njRAT in lab settings, Created and tested proof-of-concept viruses in isolated lab environments, Performed static malware analysis using Detect It Easy (DIE) and scanning services, Performed dynamic malware analysis using Process Monitor / TCPView and sandboxing.     | <a href="https://github.com/asyrafzf95/Malware-Threats">Malware & Threats</a>|
| Performed active layer-2 sniffing (MAC flooding / DHCP starvation) using macof / Yersinia, Performed packet capture and password sniffing using Wireshark, Performed detection of network sniffing and ARP poisoning in switched networks.     | <a href="https://github.com/asyrafzf95/Sniffing">Sniffing</a>|
| Conducted credential-harvesting exercises using Social-Engineer Toolkit (SET) in simulations, Detected phishing indicators and fake sites using Netcraft, Crafted social-engineering phishing content with ChatGPT for awareness campaigns.     | <a href="https://github.com/asyrafzf95/Social-Engineering">Social-Engineering</a>|
| Simulated DoS/DDoS attacks in lab environments using DDoS simulation tools, Evaluated and tested DoS/DDoS detection and protection using Anti-DDoS Guardian.     | <a href="https://github.com/asyrafzf95/Denial-of-Service-DoS-and-Distributed-Denial-of-Service-DDoS-">Denial-of-Service (DoS / DDoS)</a>|
| Performed session hijacking simulations using Caido / session interception tools, Detected and analyzed session hijacking using Wireshark session forensics.     | <a href="https://github.com/asyrafzf95/Session-Hijacking">Session Hijacking</a>|
| Performed intrusion detection and honeypot monitoring using Snort / Cowrie, Tested IDS/firewall evasion techniques including BITSAdmin-style evasion in labs.     | <a href="https://github.com/asyrafzf95/Evading-IDS-Firewalls-and-Honeypots">Evading IDS, Firewalls & Honeypots</a>|
| Performed web server footprinting with Netcat and Telnet, Executed web server exploit simulations (FTP cracking, Log4j) in test environments.     | <a href="https://github.com/asyrafzf95/Hacking-Web-Servers">Hacking Web Servers</a>|
| Performed web application reconnaissance and spidering using OWASP ZAP, Performed automated and manual web attacks (brute-force) using Burp Suite Intruder, Performed SQL and web vulnerability exploitation using sqlmap.     | <a href="https://github.com/asyrafzf95/Hacking-Web-Applications">Hacking Web Applications</a>|
| Performed SQL injection exploitation against test targets using sqlmap, Detected SQL injection vulnerabilities using OWASP ZAP scanner.    | <a href="https://github.com/asyrafzf95/SQL-Injection">SQL Injection</a>|
| Performed Wi-Fi packet analysis and inspection using Wireshark (Wi-Fi), Performed WPA2 cracking tests using Aircrack-ng in lab environments.     | <a href="https://github.com/asyrafzf95/Hacking-Wireless-Networks">Hacking Wireless Networks</a>|
| Performed Android exploitation via ADB / PhoneSploit in controlled labs, Performed Android hardening and malware mitigation testing using AVG / hardening tools.     | <a href="https://github.com/asyrafzf95/Hacking-Mobile-Platforms">Hacking Mobile Platforms</a>|
| Performed IoT footprinting using online IoT reconnaissance tools, Captured and analyzed IoT device traffic using Wireshark, Performed CAN protocol replay testing in lab OT scenarios.     | <a href="https://github.com/asyrafzf95/IoT-and-OT-Hacking">IoT & OT Hacking</a>|
| Performed Azure reconnaissance using AADInternals, Tested and enumerated S3 bucket exposures using AWS CLI, Tested IAM privilege escalation through misconfigured policies, Performed container image vulnerability assessment using Trivy.     | <a href="https://github.com/asyrafzf95/Cloud-Computing">Cloud Computing</a>|
| Performed hashing and encoding tasks using CyberChef, Created and managed self-signed certificates using OpenSSL, Performed disk encryption and secure containerization using VeraCrypt.    | <a href="https://github.com/asyrafzf95/Cryptography">Cryptography</a>|
